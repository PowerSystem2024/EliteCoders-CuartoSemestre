...
3. Configurar el archivo de propiedades de la aplicación:
   - Copiar el archivo `application.properties.example` a `application.properties` en la carpeta `src/main/resources/`
   - Modificar el archivo "application.properties" con el usuario y contraseña de la base de datos MySQL
